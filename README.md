...
**Fifty players on one ship. A woman who does not have to help him, and does.**

A story addon for the [Mythos](https://github.com/Crew-co/Mythos) engine — the era **`the-golden-fleece`**.

📖 **[Read the wiki →](https://github.com/Crew-co/Argonautica/wiki)** · roles, powers, extension points
...
./gradlew build          # → build/libs/Argonautica-0.1.0.jar
